...
export const timelineData = [
  ...
  },
  {
    ...
    content: {
      ...
      duration: 75,
      exercises: [
        { name: '深蹲', sets: 5, reps: '10,8,8,6,6', weight: '80,90,100,100,100' },
        { name: '腿举', sets: 4, reps: '12,12,10,10', weight: '120,140,150,150' },
    ...
    schedule: [
      {
        ...
        focus: 'HIIT训练',
        exercises: [
          { name: '30秒冲刺/30秒休息', sets: 10, repsRange: '-', rest: '完成后休息2分钟' },
      ...
      },
      {
        ...
        focus: '上肢+有氧',
        exercises: [
          { name: '超级组：俯卧撑+引体向上', sets: 4, repsRange: '最大次数', rest: '60秒' },
          { name: '超级组：肩上推举+侧平举', sets: 3, repsRange: '12-15', rest: '60秒' },
          { name: '超级组：窄握俯卧撑+哑铃弯举', sets: 3, repsRange: '12-15', rest: '60秒' },
          { name: '有氧训练(跑步/单车/椭圆机)', sets: 1, repsRange: '20-30分钟', rest: '-' }
        ]
      },
      {
        day: 3,
        ...
        exercises: [
          ...
          { name: '有氧训练(跑步/单车/椭圆机)', sets: 1, repsRange: '30分钟', rest: '-' }
        ]
      },
      {
        day: 4,
      ...
      },
      {
        ...
        focus: '下肢+有氧',
        exercises: [
          { name: '超级组：深蹲+箭步蹲', sets: 4, repsRange: '15次', rest: '60秒' },
          { name: '超级组：腿弯举+小腿提踵', sets: 3, repsRange: '15次', rest: '60秒' },
          { name: '超级组：箱式跳+深蹲跳', sets: 3, repsRange: '10次', rest: '60秒' },
          { name: '有氧训练(跑步/单车/椭圆机)', sets: 1, repsRange: '20-30分钟', rest: '-' }
        ]
      },
      {
        ...
        focus: '全身循环训练',
        exercises: [
          { name: '循环：深蹲', sets: 3, repsRange: '15次', rest: '仅在完成整个循环后' },
          { name: '循环：俯卧撑', sets: 3, repsRange: '12次', rest: '仅在完成整个循环后' },
          { name: '循环：单臂划船', sets: 3, repsRange: '12次/每侧', rest: '仅在完成整个循环后' },
          { name: '循环：平板支撑', sets: 3, repsRange: '30秒', rest: '仅在完成整个循环后' },
          { name: '循环：跳绳', sets: 3, repsRange: '45秒', rest: '完成循环后休息2分钟' }
        ]
      },
      {
        day: 7,
