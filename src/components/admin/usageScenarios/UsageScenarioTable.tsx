              ...
              usageScenarios.map((usageScenario) => (
                <tr key={usageScenario._id} className="border-b">
                  ...
                  <td className="p-2 max-w-[250px]">
                    <div
                      className="overflow-hidden text-ellipsis whitespace-nowrap"
                      title={usageScenario.description}
                    >
                      {usageScenario.description}
                    </div>
                  </td>
                  <td className="p-2">
                    {usageScenario.imageUrls &&
                    usageScenario.imageUrls.length > 0 ? (
                      <div className="flex gap-1">
                        <div
                          className="relative w-12 h-12 cursor-pointer overflow-hidden rounded-md border border-gray-200"
                          onClick={() =>
                            openImagePreview(usageScenario.imageUrls || [], 0)
                          }
                        >
                          <img
                        ...
                        {usageScenario.imageUrls.length > 1 && (
                          <div
